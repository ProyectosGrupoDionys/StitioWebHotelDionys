  ...
  jQuery.extend(!0, b, {
    ...
    prepareSingleCaption: function(a) {
      ...
      if (
        ...
        (d._column =
          void 0 === d._column
            ? c.hasClass("rev_column_inner") ? c.closest(".rev_column") : "none"
            : d._column),
        (d._row =
          void 0 === d._row
            ? c.hasClass("rev_column_inner") ? c.closest(".rev_row") : "none"
            : d._row),
        (d._ingroup =
          void 0 === d._ingroup
      ...
      if (
        ...
        if ("full-proportional" === o) {
          ...
          (o = s
            ? q
            : !jQuery.isNumeric(o) && o.indexOf("%") > 0 ? o : parseFloat(o)),
            (p = t
              ? r
              : !jQuery.isNumeric(p) && p.indexOf("%") > 0 ? p : parseFloat(p));
        (o = void 0 === o ? 0 : o),
          (p = void 0 === p ? 0 : p),
          "off" !== d._responsive
            ? ("grid" != d._ba && s
      ...
      if (
        ...
        (o =
          "auto" === o || (!jQuery.isNumeric(o) && o.indexOf("%") > 0)
            ? "auto" === o
              ? "auto"
              : "grid" === d._ba ? e.gridwidth[e.curWinRange] * e.bw : d._gw
            : parseFloat(o) * e.bw + "px"),
          (p =
            "auto" === p || (!jQuery.isNumeric(p) && p.indexOf("%") > 0)
              ? "auto" === p
                ? "auto"
                : "grid" === d._ba ? e.gridheight[e.curWinRange] * e.bw : d._gh
    ...
    h = function(a, c, d, e, f, g, h, i, j) {
      ...
      (k.layer = i),
        (k.eventtype =
          0 === a
            ? "enteredstage"
            : a === c - 1 || a === d ? "leftstage" : "frameended"),
